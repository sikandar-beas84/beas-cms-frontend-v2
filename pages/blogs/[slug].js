            ...
            <div className="col-lg-8">
                ...
                <div className="blog-post">
                    ...
                    <div className="blog-post-time">
                        <a href="#"> <Clock size={16} /> {day} {month} {year}</a>
                    </div>
                    <div className="blog-post-author">
                        <span> By <a href="#"> <img className="img-fluid" src="assets/images/avatar1.jpg" alt=""/>{blog?.author_name}</a> </span>
                    </div>
                    <div className="blog-post-comment">
                        <a href="#"> <MessageCircle size={16} /> {blog.blog_contents.length} </a>
                    </div>
                    </div>
                    ...
                    <blockquote className="blockquote">
                        ...
                        <div className="border p-4">
                            ...
                            <div className="pl-sm-4">
                                <h6 className="mb-3"> <span className="text-primary"> Posted by: </span>{blog?.author_name}</h6>
                ...
                <div className="blog-sidebar">cbjbvujb</div>
                </div>
            </div>
            </div>
        </section>
